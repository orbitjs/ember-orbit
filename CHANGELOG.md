...
#### :bug: Bug Fix
* `ember-orbit`
  * [#441](https://github.com/orbitjs/ember-orbit/pull/441) Set owner on strategies ([@RobbieTheWagner](https://github.com/RobbieTheWagner))
...
#### :bug: Bug Fix
* `ember-orbit`
  * [#439](https://github.com/orbitjs/ember-orbit/pull/439) Set missed owner ([@RobbieTheWagner](https://github.com/RobbieTheWagner))
