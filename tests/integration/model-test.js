...
module('Integration - Model', function(hooks) {
  ...
  test('add to hasMany', async function(assert) {
    ...
    assert.ok(
      jupiter.get('moons').includes(callisto),
      'added record to hasMany'
    );
