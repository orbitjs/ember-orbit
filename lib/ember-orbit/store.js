...
var Store = Source.extend({
  ...
  addLink: function(type, id, field, relatedId) {
    ...
    var promise = this.orbitSource.addLink(type, id, field, relatedId).then(function(data) {
      return _this._lookupFromData(type, data);
    });
  ...
  removeLink: function(type, id, field, relatedId) {
    ...
    var promise = this.orbitSource.removeLink(type, id, field, relatedId).then(function(data) {
      return _this._lookupFromData(type, data);
    });
