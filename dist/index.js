...
function registerDataBuckets(owner, modules) {
...
function registerDataModels(modules) {
...
function registerDataSources(owner, modules) {
...
function registerDataStrategies(owner, modules) {
 ...
 */
function registerInjectableServices(owner) {
...
function registerModules(owner, modules) {
  const bucketModules = {};
  const modelModules = {};
  const sourceModules = {};
...
export { Cache, LiveQuery, MemorySourceFactory, Model, Store, MemorySourceFactory as StoreFactory, applyStandardSourceInjections, attr, hasMany, hasOne, key, orbit, orbitRegistry, setupOrbit };
